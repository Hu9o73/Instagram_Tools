...
def getFollowers(file="/"):
    ...
    '''
    file_path = file + "connections/followers_and_following/followers_1.html"
...
def getFollowing():
    ...
    Don't forget the "/" at the end of the filename.
    '''
    file_path = file + "connections/followers_and_following/following.html"
    with open(file_path, 'r', encoding='utf-8') as file:
        html_content = file.read()
    soup = BeautifulSoup(html_content, 'html.parser')
    a6_p_divs = soup.find_all('div', class_='_a6-p')
